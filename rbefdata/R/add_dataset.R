...
#' and set your credentials via the bef_options() function so the authentication works.
...
#' add_dataset(dataset = dataset, dataset_title = "Testtitle", open_browser = T)
#' }
#' @import RCurl
#' @import XML
#' @export add_dataset
...
add_dataset <- function(dataset, dataset_title, curl = getCurlHandle(), open_browser = F) {
